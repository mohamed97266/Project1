...
// Header styles
if ( ! function_exists( 'flashwp_header_style' ) ) :
function flashwp_header_style() {
    ...
    <?php else : ?>
        .flashwp-site-title, .flashwp-site-title a, .flashwp-site-description {color: #<?php echo esc_attr( $header_text_color ); ?>;}
    <?php endif; ?>
    </style>
    <?php
}
