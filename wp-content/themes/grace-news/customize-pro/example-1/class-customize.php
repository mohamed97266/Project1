 ...
 * @access public
 */
final class grace_news_Example_1_Customize {
	...
	public function grace_news_sections( $manager ) {
		...
		$manager->register_section_type( 'grace_news_Example_1_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new grace_news_Example_1_Customize_Section_Pro(
				$manager,
				'example_1',
				array(
					'title'    => esc_html__( 'Upgrade to Pro', 'grace-news' ),
					'pro_text' => esc_html__( 'Upgrade Now', 'grace-news' ),
					'pro_url'  => grace_news_PROTHEME_URL,
					'priority'   => 1,
				)
			)
		);
...
grace_news_Example_1_Customize::grace_news_get_instance();